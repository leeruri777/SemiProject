...
<!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse row" id="navbarSupportedContent" style="font-size : 12px;">
		...
		<div style="text-align: center;">
			<a href="/"><img id="logo" src="/images/tteok_logo.png" alt="logo" width="200px;"/></a>
		</div>
