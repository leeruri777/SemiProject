...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("div.card").click(function(event){
			...
			//	location.href="<%= ctxPath%>/product/prodList.go?prod_code="+prod_code;
	  ...
	  <div class="card col-sm-3 col-4">
	    <div class="card-body px-1">
	       <img src="../images/tinytan/4presentSet.jpg" style="width:100%">
	    	...
	    	<input id="prod_code" type="hidden" value="1"/> <!-- value에 DB연결하고 prod_code 넣을것 -->
	    </div>
	  </div>
	  ...
	  <div class="card col-sm-3 col-4">
	    <div class="card-body px-1 ">
	      <img src="../images/tinytan/4jong.jpg" style="width:100%">
	        ...
	        <input id="prod_code" type="hidden" value="2"/>
	    </div>
	  </div>
	  ...
	  <div class="card col-sm-3 col-4">
	    <div class="card-body px-1">
	      <img src="../images/tinytan/winterSet.jpg" style="width:100%">
	        ...
	        <input id="prod_code" type="hidden" value="3"/>
	    </div>
	  </div>
	  ...
	  <div class="card col-sm-3 col-4">
		    <div class="card-body px-1">
		       <img src="../images/tinytan/4presentSet.jpg" style="width:100%">
		        <span id="font1">타이니탄 인기크림떡 4종 선물세트</span><br>
		        <span id="font1">(윈터페스타크림떡 틴케이스 세트증정)<br><b>29,800원</b></span>
		        <input id="prod_code" type="hidden" value="4"/>
		    </div>
	  </div>
	  ...
	  <div class="card col-sm-3 col-4">
	    <div class="card-body px-1">
	       <img src="../images/tinytan/4presentSet.jpg" style="width:100%">
	        <span id="font1">타이니탄 인기크림떡 4종 선물세트</span><br>
	        <span id="font1">(윈터페스타크림떡 틴케이스 세트증정)<br><b>29,800원</b></span>
	        <input id="prod_code" type="hidden" value="5"/>
	    </div>
	  </div>
	  ...
	  <div class="card col-sm-3 col-4">
	    <div class="card-body px-1">
	       <img src="../images/tinytan/4presentSet.jpg" style="width:100%">
	        <span id="font1">타이니탄 인기크림떡 4종 선물세트</span><br>
	        <span id="font1">(윈터페스타크림떡 틴케이스 세트증정)<br><b>29,800원</b></span>
	        <input id="prod_code" type="hidden" value="6"/>
	    </div>
	  </div>
